          ...
          <div className="hero__inner">
            <div className="hero__left">
              ...
              <p className="hero__lead">
                ...
                Chain. Deposit <b>USDC</b> or <b>USDT</b> from any chain and
                mint PUSD 1:1. <br />
                <br />
                <em>Always backed</em>. Redeem into USDC or USDT anytime on the chain of
                your choice.
              </p>
            </div>
        ...
        <div className="container">
          <div className="stat-strip">
            ...
            <div className="stat">
              ...
              <div className="stat__sub">
                MINT FREE · REDEEM {stats.baseFeeBps} BPS
              </div>
            </div>
          </div>
        </div>
